...
def configure_retriever(uploaded_files):
    ...
    vectordb = Redis.from_documents(splits, embeddings)
...
def reset_msg_history(msgs: RedisChatMessageHistory):
    msgs.clear()
    msgs.add_message(SystemMessage("""You are a friendly AI assistant that can help a user understand their chosen PDF document.
